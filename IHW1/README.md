...
- Осуществил взаимодействие между двумя независимыми процессами разных
...
- Размеры буферов для хранения вводимых данных и результатов обработки должны быть не более 128 байт.
- [Ссылка на 5 тестов](mark9/tests)

## Инструкция: **Все тоже самое что и в решении на 8 баллов.**
